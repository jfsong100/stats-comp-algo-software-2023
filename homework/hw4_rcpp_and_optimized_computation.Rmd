...
**Answer**: Based on my computer output, there is no difference after I change the code trying to turned on or turned off the SSE, AVX, and FMA. All the results show a time around 60ms. This may be due to M1 chip doesn't support SSE, AVX, and FMA optimization compilers. 
